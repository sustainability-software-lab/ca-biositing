...
def main():
    ...
    # Combined filters
    all_filters = status_sel & res_sel & prod_sel & prov_sel & qc_sel & exp_sel
    ...
    points = main_base.mark_circle(size=60, opacity=0.7).encode(
        ...
        tooltip=['record_id', 'experiment_name', 'prepared_sample_name', 'resource_name', 'primary_ag_product', 'provider_code', 'data_status', 'qc_pass', 'value', 'prox_sum']
    ).transform_calculate(
    ...
    export_path = "exports/plots/composition/proximate_distribution.html"
    ...
    dashboard.save("exports/plots/composition/proximate_distribution_dashboard.html")
    inject_click_export("exports/plots/composition/proximate_distribution_dashboard.html")

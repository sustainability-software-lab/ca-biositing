...
def main():
    ...
    points = main_base.mark_circle(size=60, opacity=0.7).encode(
        ...
        tooltip=['record_id', 'experiment_name', 'prepared_sample_name', 'resource_name', 'primary_ag_product', 'provider_code', 'data_status', 'qc_pass', 'value', 'unit', 'comp_sum']
    ).transform_calculate(
    ...
    export_path = "exports/plots/composition/compositional_distribution.html"

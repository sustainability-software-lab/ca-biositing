...
class InfrastructureCrudeOilPipelines(SQLModel, table=True):
    __tablename__ = "infrastructure_crude_oil_pipelines"
    ...
    master_oid: Optional[Decimal] = Field(default=None)

...
def load(df: pd.DataFrame) -> bool:
    """
    Upserts InfrastructureLivestockAnaerobicDigesters records into the database.
    ...
    try:
        from ca_biositing.datamodels.models import InfrastructureLivestockAnaerobicDigesters

        now = datetime.now(timezone.utc)
        table_columns = {c.name for c in InfrastructureLivestockAnaerobicDigesters.__table__.columns}

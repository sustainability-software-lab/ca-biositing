"""
ETL Transform: Railways.

Transforms raw GeoJSON data from the US Railways dataset into a
structured format matching InfrastructureRailways.
...
EXTRACT_SOURCES: List[str] = ["railways"]
...
def transform(
    ...
    """
    Transforms raw railway GeoJSON data.
    ...
    Returns:
        A DataFrame ready for loading into infrastructure_railways.
    """
    try:
    ...
    for source_name in EXTRACT_SOURCES:
        ...
        coerced_df = coercion_mod.coerce_columns(
            ...
            float_cols=["volume", "dir_flag", "capacity", "vcr", "shape_length", "length"],

"""
ETL Transform: Petroleum Pipelines.

Transforms raw GeoJSON data from the US Petroleum Pipelines dataset into a
structured format matching InfrastructurePetroleumPipelines.
...
def transform(
    ...
    """
    Transforms raw petroleum pipeline GeoJSON data.
    ...
    Returns:
        A DataFrame ready for loading into infrastructure_petroleum_pipelines.
    """
    try:
    ...
    for source_name in EXTRACT_SOURCES:
        ...
        coerced_df = coercion_mod.coerce_columns(
            ...
            float_cols=["volume", "capacity", "shape_length", "length"],

...
!(function (e, t) {
  ...
  var K = "2.15.0",
    ...
    z = p(function (e) {
      ...
      t({
        insights: r,
        insightsEvents: L({ items: n }).map(function (e) {
  ...
  function G(e) {
    var t = (function (e) {
                ...
                M(
                  n.map(function (e) {
                    return W(
                      W({}, e),
                      {},
                      { algoliaSource: J(e.algoliaSource, r.context) },
                    );
                  }),
                ),
              );
      ...
      i = t.onSelect,
      u = t.onActive,
      a = t.__autocomplete_clickAnalytics,
      l = n;
    if (
      (n ||
        (function (e) {
      ...
      m = p(function (e) {
        ...
        if (t.isOpen) {
          ...
          h(
            ...
            ((s.current = n),
            n.length > 0 &&
              z({ onItemsChange: o, items: n, insights: c, state: t }));
        }
      }, 0);
    return {
      ...
      subscribe: function (e) {
        ...
        (l("addAlgoliaAgent", "insights-plugin"),
          o(),
          l("onUserTokenChange", function (e) {
            o(e);
          }),
              ...
              i({
                ...
                insightsEvents: [
                  W(
                    ...
                    j({ item: t, items: o.getItems().filter(F) }),
                  ),
                ],
              });
          }),
              ...
              u({
                ...
                insightsEvents: [
                  W(
                    ...
                    j({ item: t, items: n.getItems().filter(F) }),
                  ),
                ],
              });
          }));
  ...
  function Y(e, t) {
    ...
    return {
      then: function (t, r) {
        return Y(e.then(ee(t, n, e), ee(r, n, e)), n);
      },
      catch: function (t) {
        return Y(e.catch(ee(t, n, e)), n);
      },
      finally: function (t) {
        return (
  ...
  function Z(e) {
    return Y(e, { isCanceled: !1, onCancelList: [] });
  }
  function ee(e, t, n) {
    return e
      ? function (n) {
      ...
      for (i.s(); !(n = i.n()).done; ) {
        var u,
          ...
          c =
            ...
            void 0 === u ||
            null === (a = (l = u).awaitSubmit) ||
            void 0 === a
              ? void 0
              : a.call(l);
        if ("number" == typeof c) o.push(c);
        else if (!0 === c) {
          r = !0;
          break;
        }
        ...
        {},
        {
          requests: e.queries.map(function (n) {
            return {
              query:
                "algolia" === e.requesterId
                  ? Be(Be({}, n), {}, { params: Be(Be({}, r), n.params) })
                  : n,
              sourceId: t,
  ...
  function He(e) {
    var t = e
      ...
      .map(function (e) {
        if (!Ue(e)) return Promise.resolve(e);
        var t = e,
          n = t.execute,
          r = t.items;
  ...
  var Qe = ["event", "nextState", "props", "query", "refresh", "store"];
  function Ke(e, t) {
    var n = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var r = Object.getOwnPropertySymbols(e);
  ...
  function tt(e) {
    ...
    var h = Z(
      et(
        o
          .getSources($e({ query: i, refresh: u, state: a.getState() }, l))
          .then(function (e) {
            return Promise.all(
              e.map(function (e) {
                return Promise.resolve(
                  e.getItems(
                    $e({ query: i, refresh: u, state: a.getState() }, l),
                  ),
                ).then(function (t) {
                  return Me(t, e.sourceId, a.getState());
                });
              }),
            )
              .then(He)
  ...
  var ct = ["props", "refresh", "store"],
    st = ["inputElement", "formElement", "panelElement"],
    ft = ["inputElement"],
    ...
    return {
            ...
            "aria-controls": r.getState().isOpen
              ? r
                  ...
                  .collections.map(function (e) {
                    var n = e.source;
                    return pe(t.id, "list", n);
                  })
                  .join(" ")
              : void 0,
            "aria-labelledby": pe(t.id, "label"),
          },
          e,
        );
      },
      getFormProps: function (e) {
        ...
        var i = gt(e, ft),
          u = function (i) {
            var u;
            (t.onSubmit(yt({ event: i, refresh: n, state: r.getState() }, o)),
        ...
        return yt(
          {
            ...
            onSubmit: function (e) {
              e.preventDefault();
              var n = se(t.plugins, r.pendingRequests);
              void 0 !== n
                ? n.then(function () {
                    return u(e);
                  })
            ...
            onReset: function (i) {
              var u;
              (i.preventDefault(),
                t.onReset(yt({ event: i, refresh: n, state: r.getState() }, o)),
      ...
      getLabelProps: function (e) {
        return yt({ htmlFor: pe(t.id, "input"), id: pe(t.id, "label") }, e);
      },
        ...
        return yt(
          {
            ...
            onKeyDown: function (e) {
              ve(e).isComposing ||
                (function (e) {
                  ...
                  if ("ArrowUp" === t.key || "ArrowDown" === t.key) {
                    ...
                    if (
                      ...
                      var l = se(n.plugins, o.pendingRequests);
                      return void (void 0 !== l
                        ? l.then(o.pendingRequests.cancelAll)
                ...
                })(yt({ event: e, props: t, refresh: n, store: r }, o));
            },
            onFocus: u,
            onBlur: _,
            onClick: function (n) {
      ...
      getItemProps: function (e) {
        ...
        return yt(
          {
            id: pe(t.id, "item-".concat(i.__autocomplete_id), u),
            role: "option",
  ...
  function Pt(e) {
    ...
    return {
      ...
      options: St({ "autocomplete-core": Object.keys(u) }, l),
      ua: S.concat(
  ...
  function wt(e) {
    ...
    return !1 === n.isOpen || null === n.activeItemId
      ? null
      : (null === (t = fe(n)) || void 0 === t ? void 0 : t.itemInputValue) ||
          null;
  }
  function It(e) {
    return (
  ...
  var Ct = function (e, t) {
    switch (t.type) {
      ...
      case "mousemove":
        return Et(Et({}, e), {}, { activeItemId: t.payload });
      case "setQuery":
        return Et(Et({}, e), {}, { query: t.payload, completion: null });
      case "setCollections":
        return Et(Et({}, e), {}, { collections: t.payload });
      case "setIsOpen":
        return Et(Et({}, e), {}, { isOpen: t.payload });
      case "setStatus":
        return Et(Et({}, e), {}, { status: t.payload });
      case "setContext":
        return Et(Et({}, e), {}, { context: Et(Et({}, e.context), t.payload) });
      case "ArrowDown":
        var n = Et(
          Et({}, e),
          {},
          {
            activeItemId: t.payload.hasOwnProperty("nextActiveItemId")
              ...
              : re(1, e.activeItemId, b(e), t.props.defaultActiveItemId),
          },
        );
        return Et(Et({}, n), {}, { completion: wt({ state: n }) });
      case "ArrowUp":
        var r = Et(
          Et({}, e),
          {},
        ...
        return Et(Et({}, r), {}, { completion: wt({ state: r }) });
      case "Escape":
        return e.isOpen
          ? Et(
              Et({}, e),
      ...
      case "blur":
        return t.props.debug
          ? e
          : Et(Et({}, e), {}, { isOpen: !1, activeItemId: null });
      case "mouseleave":
        return Et(Et({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
      default:
        return (
  ...
  function qt(e) {
    var t = [],
      ...
      r = ge(Ct, n, function (e) {
        ...
        if (
          (n.onStateChange(
            Nt(
              { prevState: i, state: c, refresh: u, navigator: n.navigator },
              o,
            ),
          ),
          !l() &&
                ...
                return Oe(
                  ...
                  {},
                  {
                    items: m(e.items).map(function (e) {
                      return Oe(Oe({}, e), {}, { __autocomplete_id: n++ });
                    }),
                  },
                );
              });
      ...
      i = ht(Nt({ props: n, refresh: u, store: r, navigator: n.navigator }, o));
    function u() {
      return tt(
        Nt(
          {
    ...
    return (
      ...
      (function (e) {
        ...
        metadata: Pt({ plugins: n.plugins, options: e }),
        environment: n.environment,
      }),
      Nt(Nt({ refresh: u, navigator: n.navigator }, i), o)
    );
  }
  ...
  var Qt = ["ontouchstart", "ontouchend", "ontouchmove", "ontouchcancel"];
  function Kt(e, t, n) {
  ...
  function zt(e, t, n) {
    ...
    if ("style" === t)
      ...
      else for (t in n) (i && n[t] === i[t]) || Kt(e.style, t, n[t]);
    else
      "o" === t[0] && "n" === t[1]
        ? ((r = t !== (t = t.replace(/Capture$/, ""))),
          ((o = t.toLowerCase()) in e || Qt.includes(o)) && (t = o),
          (t = t.slice(2)),
          e._listeners || (e._listeners = {}),
          (e._listeners[t] = n),
          n
            ? i || e.addEventListener(t, $t, r)
            : e.removeEventListener(t, $t, r))
        : "list" !== t &&
            "tagName" !== t &&
            "form" !== t &&
            "type" !== t &&
  ...
  function Jt(e, t) {
    for (var n in t) zt(e, Gt(n), t[n]);
  }
  function Xt(e, t) {
    for (var n in t) ("o" === n[0] && "n" === n[1]) || zt(e, Gt(n), t[n]);
  }
  var Yt = ["children"];
  function Zt(e) {
    return function (t, n) {
      ...
      return (Jt(a, i), a.append.apply(a, l(o)), a);
    };
  }
  var en = [
  ...
  function rn(e) {
    var t = e.autocomplete,
      ...
      y = v(
        "div",
        n({ class: o.root, ariaLabel: m.detachedSearchButtonTitle }, d),
      ),
      b = v("div", {
      ...
      _ = v("button", {
        ...
        children: [nn({ environment: i })],
      }),
      O = v(
        "label",
        n({ class: o.label, children: [_], ariaLabel: m.submitButtonTitle }, h),
      ),
      S = v("button", {
        class: o.clearButton,
        type: "reset",
        title: m.clearButtonTitle,
        children: [Ft({ environment: i })],
      }),
      j = v("div", {
        class: o.loadingIndicator,
        children: [tn({ environment: i })],
      }),
      P = (function (e) {
    ...
    if (a) {
      var T = v("div", {
        ...
        q = v("button", {
          ...
          title: m.detachedSearchButtonTitle,
          id: h.id,
          onClick: function () {
            f(!0);
          },
  ...
  function bn(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (u.children = arguments.length > 3 ? on.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (i in e.defaultProps) void 0 === u[i] && (u[i] = e.defaultProps[i]);
    return gn(e, u, r, o, null);
  }
  function gn(e, t, n, r, o) {
    ...
    return (null == o && null != un.vnode && un.vnode(i), i);
  }
  function hn(e) {
    return e.children;
  }
  ...
  function jn(e) {
    ((!e.__d && (e.__d = !0) && ln.push(e) && !Pn.__r++) ||
      cn !== un.debounceRendering) &&
      ((cn = un.debounceRendering) || sn)(Pn);
  }
  function Pn() {
    var e, t, n, r, o, i, u, a;
    for (ln.sort(fn); (e = ln.shift()); )
      e.__d &&
        ((t = ln.length),
        (r = void 0),
        (o = void 0),
        ...
        (a = n.__P) &&
          ...
          Tn(r, i),
          i.__e != u && Sn(i)),
        ln.length > t && ln.sort(fn));
    Pn.__r = 0;
  }
  function wn(e, t, n, r, o, i, u, a, l, c) {
    var s,
      f,
      p,
      m,
      ...
      if (
        ...
        (m = n.__k[s] =
          null == (m = t[s]) || "boolean" == typeof m || "function" == typeof m
            ...
            : "string" == typeof m ||
                "number" == typeof m ||
                "bigint" == typeof m
              ? gn(null, m, null, null, m)
              : Array.isArray(m)
                ? gn(hn, { children: m }, null, null, null)
                : m.__b > 0
                  ? gn(m.type, m.props, m.key, m.ref ? m.ref : null, m.__v)
                  : m)
      ) {
        if (
          ((m.__ = n),
        ...
        (Nn(e, m, (p = p || pn), o, i, u, a, l, c),
          ...
          null != v
            ...
            : l && p.__e == l && l.parentNode != e && (l = On(p)));
      }
    for (n.__e = d, s = g; s--; )
      null != b[s] &&
        ("function" == typeof n.type &&
          null != b[s].__e &&
          b[s].__e == n.__d &&
          (n.__d = En(r).nextSibling),
        Rn(b[s], b[s]));
    if (y) for (s = 0; s < y.length; s++) Bn(y[s], y[++s], y[++s]);
  }
  function In(e, t, n) {
  ...
  function Dn(e, t, n) {
    "-" === t[0]
      ...
      : (e[t] =
          null == n ? "" : "number" != typeof n || vn.test(t) ? n : n + "px");
  }
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof r && (e.style.cssText = r = ""), r))
          for (t in r) (n && t in n) || Dn(e.style, t, "");
        if (n) for (t in n) (r && n[t] === r[t]) || Dn(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      ((i = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + i] = n),
        n
          ? r || e.addEventListener(t, i ? xn : kn, i)
          : e.removeEventListener(t, i ? xn : kn, i));
  ...
  function kn(e) {
    return this.l[e.type + !1](un.event ? un.event(e) : e);
  }
  function xn(e) {
    return this.l[e.type + !0](un.event ? un.event(e) : e);
  }
  function Nn(e, t, n, r, o, i, u, a, l) {
    var c,
      s,
      f,
      p,
      ...
      e: if ("function" == typeof P) {
        if (
          ...
          null != P.getDerivedStateFromProps &&
            (s.__s == s.state && (s.__s = dn({}, s.__s)),
            dn(s.__s, P.getDerivedStateFromProps(y, s.__s))),
          (p = s.props),
          (m = s.state),
          (s.__v = t),
          f)
        ...
        ((s.state = s.__s),
          null != s.getChildContext && (r = dn(dn({}, r), s.getChildContext())),
          f ||
            null == s.getSnapshotBeforeUpdate ||
            (v = s.getSnapshotBeforeUpdate(p, m)),
          (j =
            null != c && c.type === hn && null == c.key ? c.props.children : c),
          wn(e, Array.isArray(j) ? j : [j], t, n, r, o, i, u, a, l),
          (s.base = t.__e),
          (t.__h = null),
  ...
  function qn(e, t, n, r, o, i, u, a) {
    ...
    if (null === m) f === p || (a && e.data === p) || (e.data = p);
      ...
      if (
        ...
        (c = (f = n.props || pn).dangerouslySetInnerHTML),
      ...
      if (
        ...
        for (v = i.length; v--; ) null != i[v] && yn(i[v]);
      a ||
        ("value" in p &&
          void 0 !== (v = p.value) &&
          (v !== e.value ||
            ("progress" === m && !v) ||
            ("option" === m && v !== f.value)) &&
          Cn(e, "value", v, f.value, !1),
        "checked" in p &&
          void 0 !== (v = p.checked) &&
          v !== e.checked &&
          Cn(e, "checked", v, f.checked, !1));
    }
    return e;
  }
  function Bn(e, t, n) {
  ...
  function Rn(e, t, n) {
    var r, o;
    if (
      (un.unmount && un.unmount(e),
      (r = e.ref) && ((r.current && r.current !== e.__e) || Bn(r, null, t)),
      null != (r = e.__c))
    ) {
    ...
    (n || null == e.__e || yn(e.__e), (e.__ = e.__e = e.__d = void 0));
  }
  function Ln(e, t, n) {
  ...
  ((on = mn.slice),
    ...
    (_n.prototype.setState = function (e, t) {
      ...
      ((n =
        null != this.__s && this.__s !== this.state
          ? this.__s
          : (this.__s = dn({}, this.state))),
        "function" == typeof e && (e = e(dn({}, n), this.props)),
        e && dn(n, e),
        null != e && this.__v && (t && this._sb.push(t), jn(this)));
    }),
    (_n.prototype.forceUpdate = function (e) {
      this.__v && ((this.__e = !0), e && this.__h.push(e), jn(this));
    }),
    (_n.prototype.render = hn),
    (ln = []),
    (sn =
    ...
    (Pn.__r = 0));
  var Fn = "__aa-highlight__",
    Un = "__/aa-highlight__";
  function Mn(e) {
    var t = e.highlightedValue.split(Fn),
      n = t.shift(),
      r = (function () {
        var e =
  ...
  function Wn(e) {
    var t = e.hit,
      ...
      o = y(t, ["_highlightResult"].concat(Hn(r), ["value"]));
    return (
      "string" != typeof o && (o = y(t, r) || ""),
      Mn({ highlightedValue: o })
    );
  }
  var Qn = {
      "&amp;": "&",
  ...
  function er(e) {
    return e.some(function (e) {
      ...
      ? e.map(function (t, n) {
          return Yn(Yn({}, t), {}, { isHighlighted: !Gn(e, n) });
        })
      : e.map(function (e) {
          return Yn(Yn({}, e), {}, { isHighlighted: !1 });
        });
  }
  function tr(e) {
    return (
  ...
  function rr(e) {
    var t = e.hit,
      n = e.attribute,
      r = Array.isArray(n) ? n : [n],
      o = y(t, ["_snippetResult"].concat(tr(r), ["value"]));
    return (
      "string" != typeof o && (o = y(t, r) || ""),
      Mn({ highlightedValue: o })
    );
  ...
  function yr(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        Wn({ hit: r, attribute: o }).map(function (e, n) {
  ...
  function br(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        ((r = { hit: o, attribute: i }), er(Wn(r))).map(function (e, n) {
  ...
  function gr(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        ((r = { hit: o, attribute: i }), er(rr(r))).map(function (e, n) {
          return e.isHighlighted ? t(a, { key: n }, e.value) : e.value;
        }),
      );
    }
  ...
  function hr(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        rr({ hit: r, attribute: o }).map(function (e, n) {
          return e.isHighlighted ? t(u, { key: n }, e.value) : e.value;
        }),
      );
    }
  ...
  var wr = [{ segment: "autocomplete-js", version: O }],
    Ir = ["components"];
  var Ar = (function (e, t) {
    function n(t) {
      return e({
    ...
    return function (e) {
      return function (r) {
        return ur(ur({ requesterId: t, execute: n }, e), r);
      };
    };
  })(function (e) {
    return (function (e) {
      ...
      "function" == typeof t.addAlgoliaAgent &&
        [].concat(vr(S), vr(o)).forEach(function (e) {
          var n = e.segment,
            r = e.version;
        ...
        .search(
          n.map(function (e) {
            ...
            return fr(
              ...
              {
                params: fr(
                  { hitsPerPage: 5, highlightPreTag: Fn, highlightPostTag: Un },
                  t,
                ),
              },
            );
  ...
  ((e.autocomplete = function (e) {
    var t,
      ...
      _ = m(function () {
        return (function (e) {
          ...
          var I = n(n({}, jr), h),
            A = {
              Highlight: yr(I),
              ReverseHighlight: br(I),
              ReverseSnippet: gr(I),
              Snippet: hr(I),
            };
          return {
            renderer: {
              classNames: Mt(Or, null != r ? r : {}),
              container: w,
              getEnvironmentProps:
                null != i
                  ? i
              ...
              panelContainer: v ? Ut(P, v) : P.document.body,
            ...
            {},
            {
              onStateChange: function (e) {
                ...
                ((y.current = e.state.collections.some(function (e) {
                  ...
                  null === (n = (r = _.value.core).onStateChange) ||
                    void 0 === n ||
                    n.call(r, e));
              },
              shouldPanelOpen:
                ...
                function (e) {
                  ...
                  var r = Boolean(
                    y.current || _.value.renderer.renderNoResults,
                  );
                  return (!n && r) || n;
                },
              __autocomplete_metadata: { userAgents: wr, options: e },
            },
          ),
        );
      }),
      ...
      I = m(function () {
        return Lt.bind(_.value.renderer.renderer.createElement);
      }),
      A = m(function () {
        return rn({
    ...
    function D(e) {
      ...
      (!(function (e) {
        ...
        (Xt(
          ...
          Jt(o.label, { hidden: "stalled" === u.status }),
          Jt(o.loadingIndicator, { hidden: "stalled" !== u.status }),
          Jt(o.clearButton, { hidden: !u.query }),
          Jt(o.detachedSearchButtonQuery, { textContent: u.query }),
          Jt(o.detachedSearchButtonPlaceholder, { hidden: Boolean(u.query) }));
      })(t),
        (function (e, t) {
    ...
    function k(e) {
      e !==
        _.value.core.environment.document.body.contains(

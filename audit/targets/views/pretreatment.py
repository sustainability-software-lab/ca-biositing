# audit/targets/views/pretreatment.py
#
# Granular audit target for pretreatment analysis records only.
#
# Filter parity with mv_biomass_composition / ANALYSIS_DATA_VIEW:
#   - qc_pass != 'fail'
#   - no additional sum or unit constraints (pretreatment is in the "all other types" branch)
...
register(AuditTarget(
    ...
    source_type="view",
    description=(
        "Pretreatment analysis records: outcomes of biomass pretreatment experiments "
        "(e.g. glucan recovery, xylan recovery, solubilization yields after acid/alkaline/steam "
        "pretreatment). Filtered to qc_pass != 'fail'. Excludes problematic resources."
    ),
    ...
    population_sql="""
        ...
        JOIN public.observation o
            ...
            AND o.record_type = 'pretreatment'
    ...
    gx_suite_path="audit/expectations/pretreatment.json",

...
Revision ID: 87835166014d
Revises: 0002
Create Date: 2026-05-08 12:29:22.675055
...
def upgrade() -> None:
    ...
    sa.Column('strain', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('note', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('api_name', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_table('bioconversion_method',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('strain_name', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['resource_id'], ['resource.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('resource_name', 'image_url', 'sort_order', name='resource_image_name_url_sort_key')
    )
    ...
    sa.Column('production_energy_content', sa.BigInteger(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['analyst_id'], ['contact.id'], ),
    sa.ForeignKeyConstraint(['bioconversion_method_id'], ['bioconversion_method.id'], ),
    sa.ForeignKeyConstraint(['dataset_id'], ['dataset.id'], ),
    ...
    sa.ForeignKeyConstraint(['method_id'], ['method.id'], ),
    sa.ForeignKeyConstraint(['prepared_sample_id'], ['prepared_sample.id'], ),
    sa.ForeignKeyConstraint(['pretreatment_method_id'], ['method.id'], ),
    sa.ForeignKeyConstraint(['raw_data_id'], ['file_object_metadata.id'], ),
    sa.ForeignKeyConstraint(['resource_id'], ['resource.id'], ),
    sa.ForeignKeyConstraint(['strain_id'], ['strain.id'], ),
    sa.ForeignKeyConstraint(['vessel_id'], ['decon_vessel.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('record_id')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('record_id', 'record_type', 'parameter_id', 'unit_id', name='observation_unique_key')
    )
    ...
    sa.Column('lineage_group_id', sa.Integer(), nullable=True),
    sa.Column('geoid', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    sa.Column('dataset_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dataset_id'], ['dataset.id'], ),
    sa.ForeignKeyConstraint(['etl_run_id'], ['etl_run.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('begin_code', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('end_code', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table('bioconversion_method')
